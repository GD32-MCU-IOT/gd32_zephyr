...
BUILD_ASSERT(
	...
	defined(CONFIG_SOC_SERIES_GD32L23X)
	     ...
	     (GD32_OSPEED_2MHZ == GPIO_OSPEED_LEVEL0) &&
	     (GD32_OSPEED_10MHZ == GPIO_OSPEED_LEVEL1) &&
	     (GD32_OSPEED_50MHZ == GPIO_OSPEED_LEVEL2) &&
	     (GD32_OSPEED_MAX == GPIO_OSPEED_LEVEL3) &&
#elif defined(CONFIG_SOC_SERIES_GD32F527) || defined(CONFIG_SOC_SERIES_GD32W51X_F5HC)
	     (GD32_OSPEED_10MHZ == GPIO_OSPEED_10MHZ) &&
	     (GD32_OSPEED_50MHZ == GPIO_OSPEED_50MHZ) &&
	     (GD32_OSPEED_MAX == GPIO_OSPEED_MAX) &&
#elif defined(CONFIG_SOC_SERIES_GD32M53X)
	     (GD32_OSPEED_25MHZ == GPIO_OSPEED_LOW) &&
	     (GD32_OSPEED_50MHZ == GPIO_OSPEED_HIGH) &&
	     (GD32_OSPEED_MAX == GPIO_OSPEED_LARGE_CURRENT) &&
	  ...
	  defined(CONFIG_SOC_SERIES_GD32G5X3)
		 ...
		 (GD32_OSPEED_100_220MHZ == GPIO_OSPEED_100_220MHZ) &&
#else
