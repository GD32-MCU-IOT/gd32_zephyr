...
#define GD32_DMA_PERIPH_TX (GD32_DMA_MEMORY_TO_PERIPH | GD32_DMA_MEMORY_ADDR_INC)
#define GD32_DMA_PERIPH_RX (GD32_DMA_PERIPH_TO_MEMORY | GD32_DMA_MEMORY_ADDR_INC)
