...
#define CAN_GD32_RX_MAILBOX_START (0U)
#define CAN_GD32_RX_MAILBOX_NUM   (4U)
#define CAN_GD32_TX_MAILBOX_NUM   (5U)
#define CAN_GD32_TX_MAILBOX_START (CAN_GD32_RX_MAILBOX_START + CAN_GD32_RX_MAILBOX_NUM)
