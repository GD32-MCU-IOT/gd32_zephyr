...
#define GD32_CLOCK_SRAM0 GD32_CLOCK_CONFIG(AHB1EN, 16U) /**< SRAM0 clock gate */
#define GD32_CLOCK_SRAM1 GD32_CLOCK_CONFIG(AHB1EN, 17U) /**< SRAM1 clock gate */
#define GD32_CLOCK_SRAM2 GD32_CLOCK_CONFIG(AHB1EN, 18U) /**< SRAM2 clock gate */
#define GD32_CLOCK_SRAM3 GD32_CLOCK_CONFIG(AHB1EN, 19U) /**< SRAM3 clock gate */
...
#define GD32_CLOCK_USBFS GD32_CLOCK_CONFIG(AHB1EN, 29U) /**< USBFS clock gate */

/* AHB2 peripherals */
#define GD32_CLOCK_PKCAU GD32_CLOCK_CONFIG(AHB2EN, 3U) /**< PKCAU clock gate */
